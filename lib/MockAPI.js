(function() {
  ...
  var folios = [
    ...
    },
    {
      ...
      "id": "218e8ba4-3bf3-43cb-894f-d10aa0b1bfa3",
      "currentTransactions": [],
      "downloadSize": 0,
      "state": 100,
      "previewImageURL": null,
      ...
      "isArchivable": false,
      "isUpdatable": false,
      "productId": "com.timeinc.ew.ipad.inapp.04052013",
  ...
  folios.forEach(function(folio) { 
    folio.purchase = function() { confirm("Are you sure you want to buy this?") }
