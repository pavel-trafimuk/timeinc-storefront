...
window.libBanner = (function() {
  ...
  lib.cover_img_for = function cover_img_for(folio) {
    return "http://edge.adobe-dcfs.com/ddp/issueServer/issues/" + folio.id + "/libraryPreview/portrait/";
  }
  ...
  wait_for_api("trackCustomEvent", function(events, vars) {
    ...
    if (window.AB && window.AB.omnitureString) {
      vars.customVariable7 = AB.omnitureString();
    }
