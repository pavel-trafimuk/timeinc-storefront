    ...
    function Wrapper(tcm_feed, adobe_feed) {
      ...
      that.libraryService.get_visible = function() {
        ...
        function priority(folio) {
          if (folio.productId == latest_folio.productId) return 100;
        ...
        folios = _.chain(folios)
          .map(function(folio) {
            ...
            if (priority_comp != 0) return priority_comp;
            else return comp(moment(folio2.publicationDate), moment(folio1.publicationDate));
