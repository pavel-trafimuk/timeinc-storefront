  ...
  window.APIWrapper = function(raw_api, cb) {
    ...
    function Wrapper(tcm_feed, adobe_feed) {
        ...
        "view_or_preview": function(opts) {
          ...
          if (folio.isDownloadable) folio.download_and_view(opts);          
            ...
            if (folio.currentStateChangingTransaction() != null) {
              ...
              return bind_downloads_wait_for_others(folio.currentStateChangingTransaction(), arguments.callee);
            }
            var transaction;
      ...
      that.libraryService.get_visible = function() {
        ...
        if (arguments.callee.cached) return arguments.callee.cached;
        ...
        arguments.callee.cached = folios;
        return folios;
      }
      ...
      that.libraryService.updatedSignal.add(function() {
        ...
        setTimeout(function() {
          // repopulate cache
          that.libraryService.get_visible();
        }, 200);
      });
    ...
    function ensure_folios_are_loaded(cb) {
      ...
      if (_.size(raw_api.libraryService.internal) == 0) {
